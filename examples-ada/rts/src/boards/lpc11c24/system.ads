...
package System is
   ...
   System_Name : constant String := "LPCXpresso LPC11C24 Zero Footprint Runtime";
...
private
   ...
   --  TODO: Fix the following when we have support for them.
   --  TODO: To be determined.
   --  I think this would require linking libgcc.a
   Support_64_Bit_Divides    : constant Boolean := False;
   --  TODO: Next 3, needs memcpy, etc.
   ...
   --  TODO: Do we even need a main program?
